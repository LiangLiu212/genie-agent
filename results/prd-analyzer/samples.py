"""XRootD-streamed (e,e'p) samples for the prd-analyzer 4-model comparison.
...
# every overlay. Plots additionally emphasize HIGHLIGHT (thicker line + high zorder).
MODELS = ["LFG", "SF", "SuSAv2", "UnifiedQEL"]
