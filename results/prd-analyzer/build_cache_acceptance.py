...
events into results/prd-analyzer/cache/acceptance/<model>.npz.
...
bounds the streamed subset, and ntot records how many events were streamed.
    ...
    pixi run python results/prd-analyzer/build_cache_acceptance.py            # all models
    MAX_FILES=1 WORKERS=1 pixi run python results/prd-analyzer/build_cache_acceptance.py UnifiedQEL
"""
import sys
import os
import time
