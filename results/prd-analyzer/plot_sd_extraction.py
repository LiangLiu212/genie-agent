...
fig.savefig("results/prd-analyzer/sd_2d_maps.png", dpi=DPI)
print("wrote results/prd-analyzer/sd_2d_maps.png")
...
fig2.tight_layout()
fig2.savefig("results/prd-analyzer/sd_extraction_fig9.png", dpi=DPI)
print("wrote results/prd-analyzer/sd_extraction_fig9.png")
