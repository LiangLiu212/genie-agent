...
make_fig("results/prd-analyzer-v0/dists_stage1_electron.png", "1",
         "stage 1 (electron cut: El ∧ θ_e)")
make_fig("results/prd-analyzer-v0/dists_stage21_proton_e.png", "2.1",
         "stage 2.1 (El ∧ θ_e ∧ T_p, θ_p free)")
make_fig("results/prd-analyzer-v0/dists_stage2_full.png", "2",
