...
v0.1 copy of the v0 registry (results/prd-analyzer-v0/samples.py); the only
change is CACHE_DIR, which points at this version's cache (moved here from v0).
...
CACHE_DIR = "results/prd-analyzer-v0.1/cache"
